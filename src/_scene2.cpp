...
void _Scene2::reSizeWindow(int width, int height)
{
...
void _Scene2::initGL()
{
    ...
    myPrlx->parallaxInit("images/parallax2.jpg");
    pauseOverlay.init();
...
void _Scene2::drawScene()
{
    ...
    if (allPassed)
    {
        std::cout << "Level 2 Complete! Moving to next scene...\n";
        nextLevel = true;
    }
}
        ...
        case WM_KEYDOWN:
            ...
            switch (wParam)
            {
                case VK_ESCAPE:
                    ...
                    cout << (sceneSwitcher->paused ? "PAUSED" : "RESUMED") << endl;
                    break;
...
void _Scene2::mouseMapping(int x, int y)
{
    GLint viewPort[4];
